...
const Banner = () => {
    ...
    const [Color ,setColor ] =useState({bgcolor:'bg-[#FFF7CF]' ,divbg:'bg-[#F5DE6E]'})


  return (
    <>
      <section className={`${Color.bgcolor} transition-all duration-[1s] relative h-screen pt-[180px]  overflow-hidden`}>
          ...
          <div className="banner_row flex  ">
            <div className="banner_text">
              ...
              <div className="flex mt-[20px] mb-5">
                <img onClick={()=>{setRounded('rotate-[-31deg]'), setColor((prev)=>({...prev ,bgcolor:'bg-[#FFF7CF]' ,divbg:'bg-[#F5DE6E]'}))}} src={bannaIcon} alt="bannaIcon" />
                <img onClick={()=>{setRounded('rotate-[60deg]'), setColor((prev)=>({...prev ,bgcolor:'bg-[#FFE1E2]' ,divbg:'bg-[#FCB1B4]'}))}} src={StrawberryIcon} alt="StrawberryIcon" />
                <img onClick={()=>{setRounded('rotate-[150deg]'),setColor((prev)=>({...prev ,bgcolor:'bg-[#ECFFCC]' ,divbg:'bg-[#8FB351]'}))}} src={KiwiIcon} alt="KiwiIcon" />
                <img onClick={()=>{setRounded('rotate-[250deg]'), setColor((prev)=>({...prev ,bgcolor:'bg-[#FFCBEA]' ,divbg:'bg-[#C976A7]'}))}} src={bluberryIcon} alt="bluberryIcon" />
              </div>
            </div>

            {/* ====================== Image Rotede part =====================*/}

            <div className={`banner_foods ${Rounded} ${Color.divbg} transition-all duration-[1s] right-[-300px] bottom-[-550px]  absolute w-[1000px] h-[1000px] bg-bannaTwo rounded-full `}>
